...
# Danh sách từ
$words = @(
    "health","well-being","immune system","fitness","nutrition","lifestyle","stress","prevention","hygiene","diet","disease","virus","infection","symptom","diagnosis","treatment","therapy","chronic","contagious","recovery","hospital","clinic","nurse","surgeon","paramedic","ambulance","ward","emergency","appointment","operation","mental health","depression","anxiety","therapy","counselling","trauma","disorder","support group","coping mechanism","meditation","mental health","stress","depression","therapy","counselling","insomnia","trauma","wellbeing","anxiety","mindfulness","medical treatment","prescription","surgery","diagnosis","medication","dose","side effect","antibiotic","vaccine","recovery","disease","infection","virus","bacteria","outbreak","chronic illness","contagious","immune system","antibiotic","symptom","medicine","prescription","vaccine","injection","tablet","dose","pharmacy","treatment","therapy","recover","exercise","physical activity","workout","cardio","strength training","stretching","warm-up","fitness","gym","yoga","lifestyle","habit","diet","nutrition","healthy","junk food","overweight","smoking","alcohol","stress"
)
