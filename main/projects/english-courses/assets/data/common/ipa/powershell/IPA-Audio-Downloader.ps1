...
# Danh sách từ
$words = @(
    "public transport","private vehicle","electric scooter","bicycle","motorbike","train","tram","underground","ferry","airplane","transport infrastructure","highway","railway network","bus lane","pedestrian crossing","traffic signal","roundabout","bridge","tunnel","interchange","traffic congestion","rush hour","traffic jam","vehicle emissions","overcrowded roads","road rage","parking problem","commuter","bottleneck","congestion charge","carpooling","cycle lane","park and ride","subsidise public transport","fuel-efficient vehicles","electric vehicle","reduce carbon footprint","bike-sharing system","urban mobility","traffic-free zone","freight","cargo","logistics","shipment","distribution","haulage","transit","warehouse","customs clearance","freight forwarding","aviation","air traffic control","runway","airport terminal","flight delay","cargo ship","container","port","harbor","cruise","commute","subway","metro","tram","pedestrian","bike lane","overpass","intersection","traffic light","underpass","road safety","congestion","rush hour","emissions","air pollution","carbon emissions","speed limit","accident-prone","driving license","seatbelt","freight","cargo","shipping","logistics","port","container","shipment","export","import","global supply chain","autonomous vehicle","electric car","charging station","ride-sharing","high-speed rail","hyperloop","drone delivery","smart traffic system","mobility app","zero-emission vehicle"
)
