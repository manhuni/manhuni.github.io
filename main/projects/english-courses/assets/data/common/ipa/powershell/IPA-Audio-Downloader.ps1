...
# Danh sách từ
$words = @(
"police","officer","patrol","detective","investigate","raid","siren","handcuffs","warrant","interrogate","court","judge","jury","trial","verdict","lawsuit","appeal","sentence","testify","bail","criminal","suspect","accomplice","victim","theft","burglary","robbery","fraud","hijack","murder","law","rule","regulation","policy","constitution","legislation","amendment","authority","ban","penalty","punishment","fine","prison","jail","cell","probation","parole","detain","rehabilitate","execution","evidence","proof","witness","statement","testimony","confession","clue","trace","suspect","investigation","crime","offence","felony","misdemeanor","violation","culprit","convict","charge","guilt","innocence","arrest","charge","convict","sentence","accuse","plead","confess","release","appeal","prosecute","lawyer","barrister","solicitor","prosecutor","defendant","plaintiff","advocate","counsel","oath","affidavit","jury","judge","court","trial","verdict","appeal","hearing","bail","warrant","summons"
)
