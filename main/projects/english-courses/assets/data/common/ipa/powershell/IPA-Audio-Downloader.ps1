...
# Danh sách từ
$words = @(
"environment","pollution","climate","sustainable","biodiversity","deforestation","recycle","renewable","conservation","greenhouse","energy","fossil","fuel","solar","wind","power","electricity","nuclear","efficient","consume","waste","garbage","litter","landfill","dispose","decompose","incinerate","hazardous","compost","reuse","nature","wildlife","forest","habitat","ecosystem","species","flora","fauna","wilderness","preserve","disaster","flood","earthquake","tsunami","drought","famine","avalanche","volcano","hurricane","mitigate","water","river","lake","ocean","sea","wetland","aquifer","reservoir","purify","scarcity","climate change","global warming","carbon dioxide","emission","carbon footprint","methane","ozone","temperature","greenhouse effect","adapt","agriculture","farm","crop","harvest","fertilizer","pesticide","organic","irrigate","soil","yield","pollution","contaminate","toxic","acid rain","smog","noise pollution","oil spill","dump","sewage","filter","renewable energy","solar power","wind energy","hydropower","biomass","geothermal","sustainable","turbine","grid","conserve"
)
