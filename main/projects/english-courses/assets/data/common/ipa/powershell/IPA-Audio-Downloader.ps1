...
# Danh sách từ
$words = @(
"education","school","student","teacher","classroom","lesson","subject","curriculum","syllabus","homework","assignment","exam","test","degree","qualification","scholarship","grant","tuition","lecture","seminar","tutorial","research","thesis","dissertation","faculty","principal","headmaster","pupil","mentor","internship","literacy","numeracy","discipline","attendance","enrolment","dropout","tuition fee","extracurricular","distance learning","virtual classroom","curriculum","syllabus","module","lesson","curricular","academic","scholarly","pedagogy","methodology","approach","undergraduate","postgraduate","freshman","sophomore","junior","senior","graduate","alumnus","fellowship","valedictorian","enroll","register","admission","application","scholarship","grant","tuition","fee","funding","sponsor","certificate","degree","diploma","qualification","credential","transcript","honours","distinction","merit","pass","lecture","seminar","workshop","tutorial","syllabus","curriculum","module","credit","semester","term","assessment","assignment","project","dissertation","thesis","exam","quiz","grade","score","result"
)
