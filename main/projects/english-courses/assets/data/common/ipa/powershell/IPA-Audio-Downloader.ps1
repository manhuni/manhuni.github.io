...
# Danh sách từ
$words = @(
    "urbanisation","urban sprawl","infrastructure","population density","megacity","slum","housing shortage","traffic congestion","overpopulation","sustainable development","migration","emigrate","immigrant","rural","urban","internal migration","resettle","relocate","displacement","suburban","pollution","waste management","crime rate","poverty","inequality","public transport","urban planning","housing affordability","infrastructure strain","noise pollution","smart city","eco-friendly","green space","sustainable city","renewable energy","urban regeneration","walkability","urban farming","mixed-use development","bike-friendly","urban lifestyle","population density","urban dweller","migration trend","suburban area","urban expansion","rural-urban migration","housing shortage","urban poor","commuter","overcrowding","traffic congestion","pollution","urban poverty","waste management","slum","housing affordability","infrastructure strain","inequality","urban decay","sustainable city","urban planning","green space","public transport","smart city","mixed-use development","urban regeneration","walkability","urban resilience","renewable energy","population density","urban sprawl","high-rise building","housing shortage","gentrification","urban migration","inner-city","urban household","urban dweller","city skyline","air quality","noise pollution","carbon emissions","urban farming","eco-friendly","green building","urban heat island","waste recycling","stormwater management","renewable resource","urban resilience","green city","urban innovation","digital infrastructure","climate adaptation","urban sustainability","public-private partnership","smart grid","urban redevelopment","disaster preparedness"
)
