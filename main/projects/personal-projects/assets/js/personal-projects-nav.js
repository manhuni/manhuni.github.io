...
document.addEventListener("DOMContentLoaded", function () {
  const lessons = [
    { path: "liferoadmap/index.html", label: "⚙️ GitHub Actions - Auto Update Footer" }, 
  ];
  ...
  if (idx >= 0 && idx < lessons.length - 1) {
    ...
    nav.innerHTML += `<a href="/main/projects/personal-projects/${next.path}" class="btn">${next.label} →</a>`;
  }
